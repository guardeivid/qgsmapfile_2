...
from qgis.core import (QgsSymbolV2, QgsMarkerSymbolV2, QgsLineSymbolV2, QgsFillSymbolV2, \
    ...
    QgsCentroidFillSymbolLayerV2, QgsSVGFillSymbolLayer, QgsRasterFillSymbolLayer, \
    QgsLinePatternFillSymbolLayer, QgsPointPatternFillSymbolLayer, QgsSvgMarkerSymbolLayerV2)
...
class SymbolImport(object):
    ...
    #--Obtener capa de simbolo (QgsSymbolLayerV2)-------------------------
    def __getQgsMarkerSymbolLayer(self, msstyle):
        ...
        if symbol:
            ...
            qgsSymbol = QgsSimpleMarkerSymbolLayerV2.create(props)
        #print(props)
        return qgsSymbol
        ...
        if not type_marker:
            ...
            if type_marker == _ms.MS_SYMBOL_ARROW:
                ...
                if QGis.QGIS_VERSION_INT >= 21600:
                    ...
                    qgsSubSymbol = self.__getSubSymbol(QgsFillSymbolV2, QgsSimpleFillSymbolLayerV2, QGis.Fill, props)
                    self.deleteProperties(props_parent, _qgis.ARROW_SYMBOL_LAYER)
                    qgsSymbol = QgsArrowSymbolLayer.create(props_parent)
                else:
                    self.deleteProperties(props, _qgis.SIMPLE_MARKER_SYMBOL_LAYER)
                    qgsSubSymbol = self.__getSubSymbol(QgsMarkerSymbolV2, QgsSimpleMarkerSymbolLayerV2, QGis.Point, props)
        ...
        if not type_marker:
            ...
            if geomtransform == 'centroid':
                ...
                if not props['use_custom_dash']:
                    ...
                    self.deleteProperties(props, _qgis.SIMPLE_LINE_SYMBOL_LAYER)
                    qgsSubSymbol = self.__getSubSymbol(QgsLineSymbolV2, QgsSimpleLineSymbolLayerV2, QGis.Line, props)
    ...
    def __getQgsMarkerSubSymbol(self, type_marker, msSymbol, size, props, subsym=True):
        ...
        if subsym:
            return self.__getSubSymbol(QgsMarkerSymbolV2, SymbolLayer, QGis.Point, props)
        else:
