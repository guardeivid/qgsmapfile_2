...
class QgsMapfile:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Qgs Mapfile')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'QgsMapfile')
        self.toolbar.setObjectName(u'QgsMapfile')
    ...
    def importLayer(self):
        from .ui.qgsmapfileimport_dialog import QgsMapfileImportDialog
        dlg = QgsMapfileImportDialog(self.iface, self.iface.mainWindow())
        dlg.show()
        dlg.exec_()

    def exportLayer(self):
        from .ui.qgsmapfileexport_dialog import QgsMapfileExportDialog
        dlg = QgsMapfileExportDialog(self.iface, self.iface.mainWindow())
        dlg.show()
        dlg.exec_()
